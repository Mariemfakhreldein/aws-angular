...
import { CreateTrainingProgramComponent } from './compnents/training-program/create-training-program/create-training-program.component';
...
const routes: Routes = [
  ...
  // { path: 'training-programs/view', component: TrainingProgramComponent }
  { path: 'taining-programs/create', component: CreateTrainingProgramComponent}
